...
c These moved to common.
c      integer ntmax
c      logical ly,my,lx,mx,la,lp,lj,lw
c      parameter (ntmax=100)
c      integer ntroff
c      integer nmask(ntmax)
c      integer markoff,iticnum,jt1,ism
c      real xrange(2),yrange(2)
c      real xlego,ylego,cz
c      real xsf,ysf,ybh,ysxp,xof,yof
